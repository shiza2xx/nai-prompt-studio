...
assert.match(styleSource, /\[data-theme="galaxy"\] \.app-chrome \{ background: linear-gradient\(180deg, rgb\(24 10 30 \/ 97%\), rgb\(12 6 16 \/ 95%\)/);
assert.match(styleSource, /\[data-theme="galaxy"\] \.workspace-tabs \{ background: rgb\(25 11 31 \/ 94%\)/);
...
assert.match(uiSource, /const APP_VERSION = '0\.6\.9'/);
...
assert.match(uiSource, /new IntersectionObserver\(/, 'Custom Tag originals promote when entering the viewport');
